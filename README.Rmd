...
This is a basic example which shows you how to solve a common problem of compiling and summarizing multiple point count data files downloaded from the [AKN](https://avianknowledge.net).
